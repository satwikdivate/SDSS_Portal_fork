    ...
    <div className="news-container">
      ...
      <div className="Maidan-News news">
        <div className="category-dropdown-line">
          <div className="news-dropdown" onClick={toggleDropdownMaidan}>
            <h2>Maidan News</h2>{" "}
          </div>
        </div>
      ...
      <div className="Tasika-News news">
        <div className="category-dropdown-line">
          <div className="news-dropdown" onClick={toggleDropdownTasika}>
            <h2>Tasika News</h2>{" "}
          </div>
        </div>
      ...
      <div className="Karykram-News news">
        <div className="category-dropdown-line">
          <div className="news-dropdown" onClick={toggleDropdownKaryakram}>
            <h2>Karykram News</h2>{" "}
          </div>
        </div>
      ...
      <div className="Sampark-News news">
        <div className="category-dropdown-line">
          <div className="news-dropdown" onClick={toggleDropdownSampark}>
            <h2>Sampark News</h2>{" "}
          </div>
        </div>
