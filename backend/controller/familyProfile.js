...
try{
    ...
    const { motherName,fatherName,contact,occupation,income,siblingCount,}=req.body;
    
    const id=req.user.id;
    // validation
    if(!id|| !motherName|| !fatherName || !contact || !occupation || !income ||!siblingCount){
    ...
    const familyProfileId=user[0].familyProfile;
           ...
           const result=await FamilyProfile.findByIdAndUpdate({_id:familyProfileId}, {
